...
<head>
  ...
  <meta name="robot" content="<?= $meta_robots_content; ?>" />
  ...
  <link rel="canonical" href="https://kokola.co.id" />
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" />
  <link href="<?= base_url(); ?>assets/plugins/custom/cropper/cropper.bundle.css" rel="stylesheet" type="text/css" />
  ...
  <script src="<?= base_url(); ?>assets/plugins/custom/cropper/cropper.bundle.js"></script>
        ...
        <div id="kt_header" class="header align-items-stretch">
          ...
          <div class="toolbar">
            <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
              <div class="page-title d-flex align-items-center me-5">
        ...
        <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
          <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
            <div class="text-dark order-2 order-md-1">
              ...
              <a href="https://www.google.com" target="_blank" class="text-gray-800 text-hover-primary">Company</a>
            </div>
            <ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
              ...
              <li class="menu-item">
                <a href="#" target="_blank" class="menu-link px-2">Knowladge Base</a>
              </li>
            </ul>
          </div>
        </div>
